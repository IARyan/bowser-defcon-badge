...
{
    #ifdef SWB_Int_INTERRUPT_INTERRUPT_CALLBACK
        SWB_Int_Interrupt_InterruptCallback();
    #endif /* SWB_Int_INTERRUPT_INTERRUPT_CALLBACK */ 
...
*
*   Note calling SWB_Int_Start or SWB_Int_StartEx will 
*   override any effect this API would have had. This API should only be called
*   after SWB_Int_Start or SWB_Int_StartEx has been called. 
