...
{
    #ifdef SWL_Int_INTERRUPT_INTERRUPT_CALLBACK
        SWL_Int_Interrupt_InterruptCallback();
    #endif /* SWL_Int_INTERRUPT_INTERRUPT_CALLBACK */ 
...
*
*   Note calling SWL_Int_Start or SWL_Int_StartEx will 
*   override any effect this API would have had. This API should only be called
*   after SWL_Int_Start or SWL_Int_StartEx has been called. 
