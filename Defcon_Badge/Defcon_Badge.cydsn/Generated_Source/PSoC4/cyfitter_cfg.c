...
static void ClockSetup(void)
{
	...
	CY_SET_REG32((void *)(CYREG_CLK_DIVIDER_A00), 0x8000176Fu);
...
void cyfitter_cfg(void)
{
	...
	CY_SET_REG8((void *)CYREG_UDB_UDBIF_INT_CLK_CTL, 0x01u);
	{
		...
		CY_SET_REG32((void *)(CYREG_CPUSS_INTR_SELECT), 0x00000004u);

		/* INT_CONFIG Starting address: CYDEV_UDB_INT_CFG */
		CY_SET_REG32((void *)(CYREG_UDB_INT_CFG), 0x00000004u);
	...
	CY_SET_REG32((void *)(CYREG_PRT0_PC), 0x005801B6u);
	CY_SET_REG32((void *)(CYREG_PRT0_INTCFG), 0x0000C000u);

	/* IOPINS0_1 Starting address: CYDEV_PRT1_BASE */
	CY_SET_REG32((void *)(CYDEV_PRT1_BASE), 0x00000004u);
	CY_SET_REG32((void *)(CYREG_PRT1_PC), 0x00180080u);
	CY_SET_REG32((void *)(CYREG_PRT1_INTCFG), 0x00000020u);

	/* IOPINS0_2 Starting address: CYDEV_PRT2_BASE */
	CY_SET_REG32((void *)(CYDEV_PRT2_BASE), 0x00000040u);
	CY_SET_REG32((void *)(CYREG_PRT2_PC), 0x00DB0000u);

	/* IOPINS0_3 Starting address: CYDEV_PRT3_BASE */
	CY_SET_REG32((void *)(CYDEV_PRT3_BASE), 0x00000010u);
	CY_SET_REG32((void *)(CYREG_PRT3_PC), 0x00002D80u);
	CY_SET_REG32((void *)(CYREG_PRT3_INTCFG), 0x00000200u);
