...
{
    #ifdef SWR_Int_INTERRUPT_INTERRUPT_CALLBACK
        SWR_Int_Interrupt_InterruptCallback();
    #endif /* SWR_Int_INTERRUPT_INTERRUPT_CALLBACK */ 
...
*
*   Note calling SWR_Int_Start or SWR_Int_StartEx will 
*   override any effect this API would have had. This API should only be called
*   after SWR_Int_Start or SWR_Int_StartEx has been called. 
