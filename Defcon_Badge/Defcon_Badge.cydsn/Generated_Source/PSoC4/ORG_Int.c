...
{
    #ifdef ORG_Int_INTERRUPT_INTERRUPT_CALLBACK
        ORG_Int_Interrupt_InterruptCallback();
    #endif /* ORG_Int_INTERRUPT_INTERRUPT_CALLBACK */ 
...
*
*   Note calling ORG_Int_Start or ORG_Int_StartEx will 
*   override any effect this API would have had. This API should only be called
*   after ORG_Int_Start or ORG_Int_StartEx has been called. 
